 ...
 * 
 */
grapeControllers.controller("marchEastController", [
		'$scope',
		'$http',
		'$routeParams',
		'$rootScope',
		...
		function($scope, $http, $routeParams, $rootScope, $location, $interval, $window,
			...
			console.log("initiating east controller...");
			...
			$scope.setFifthRoundTeamOne = function(team) {
				if(typeof team != "undefined") {
					...
					sharedUtilService.setEastTeamOne($scope.fifthRoundTeamOne);
				}
			}

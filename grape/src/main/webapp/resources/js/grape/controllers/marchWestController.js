 ...
 * 
 */
grapeControllers.controller("marchWestController", [
		'$scope',
		'$http',
		'$routeParams',
		'$rootScope',
		...
		function($scope, $http, $routeParams, $rootScope, $location, $interval, $window,
			...
			$scope.setFifthRoundTeamOne = function(team) {
				if(typeof team != "undefined") {
					...
					sharedUtilService.setWestTeamOne($scope.fifthRoundTeamOne);
				}
			}

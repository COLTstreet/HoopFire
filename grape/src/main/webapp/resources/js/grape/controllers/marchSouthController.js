 ...
 * 
 */
grapeControllers.controller("marchSouthController", [
		'$scope',
		'$http',
		'$routeParams',
		'$rootScope',
		...
		function($scope, $http, $routeParams, $rootScope, $location, $interval, $window,
			...
			$scope.setFifthRoundTeamOne = function(team) {
				if(typeof team != "undefined") {
					...
					sharedUtilService.setSouthTeamOne($scope.fifthRoundTeamOne);
				}
			}
